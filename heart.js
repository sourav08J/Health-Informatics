// heart.js - CSV Advice + Gemini Medicine Integration (FINAL)
...
document.addEventListener('DOMContentLoaded', () => {
    ...
    function provideAdvice() {
        ...
        /* ---------- UI: Loading ---------- */
        responseBox.innerHTML = "🔍 Analyzing heart condition...";
        ...
        /* ===============================
           4. CSV-BASED HEART ADVICE
        =============================== */
        fetch("http://127.0.0.1:5000/analyze_heart", {
            method: "POST",
            headers: {
        ...
        .then(data => {
            ...
            if (!data.answer || data.answer.trim() === "") {
                responseBox.innerHTML =
                    "ℹ️ No matching heart condition found in database. Please consult a doctor.";
        ...
        .catch(err => {
            ...
            responseBox.innerHTML = "❌ Heart database not reachable.";
        ...
        =============================== */
        fetch("http://127.0.0.1:5000/heart_medicine", {
            method: "POST",
            headers: {
                "Content-Type": "application/json"
            },
